...
python /home/quest_demo/workshop/intermediate/slurm_examples/python/job-array-huge/slurm_test.py --input-argument-1 ${input_args[0]} --input-argument-2 ${input_args[1]} --input-argument-3 ${input_args[2]} 
